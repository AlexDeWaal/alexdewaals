$(function getSeries() {
    ...
    var actionMovies = ['American Gods', 'Rick and Morty', 'Stranger Things', 'Black Mirror', 'The Middle', 'Rick and Morty', 'Timeless', 'Code Black', 'Dexter', 'American Horror Story', 'Riverdale', 'American Gods', 'Wonder Woman', 'Deadpool', 'Atomic Blonde', 'Adventure Time', 'Split', 'Lucy', 'Stranger things'];
